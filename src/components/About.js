...
export default function About() {
    ...
    const [btnText, btnTextSet] = useState("Enable dark mode")
    ...
    return (
        <div className='container my-3' style={myStyle}>
            ...
            <div className="container my-3">
                <button type="button" onClick={tooggleStyle} className="btn btn-primary">{btnText}</button>
            </div>
        </div>
    )
}

        ...
        <>
            <div className="bg">
                <div className="container" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                    <div className="mb-3">
                        <h1>{props.heading}</h1>
                        <textarea className="form-control my-3" style={{ backgroundColor: props.mode === 'dark' ? '#08090B' : 'white', color: props.mode === 'dark' ? 'white' : 'black' }} value={text} onChange={handleOnChange} id="mybox" rows="8" ></textarea>
                    ...
                    {/* <div className="container my=2 replace" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                        ...
                        <div className="replacebtn">
                            <button disabled={text.length===0} className="btn btn-primary mx-1 my-2 btn-rep" onClick={handleReplace} >Replace</button>
                            <button disabled={text.length===0} className="btn btn-primary mx-1 my-2 btn-rep" onClick={handleReplaceAll} >Replace All</button>
                        </div>
                    </div> */}
                </div>
